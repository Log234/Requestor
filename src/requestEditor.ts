...
export class RequestEditorProvider implements vscode.CustomTextEditorProvider {
	...
	private static readonly viewType = 'httpioneer.editor';
	...
	private addNewScratch(document: vscode.TextDocument) {
		...
		const character = RequestEditorProvider.scratchCharacters[Math.floor(Math.random() * RequestEditorProvider.scratchCharacters.length)];
		json.scratches = [
